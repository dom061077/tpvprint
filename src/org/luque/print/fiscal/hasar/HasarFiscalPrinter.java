package org.luque.print.fiscal.hasar;
...
import org.luque.print.fiscal.BasicFiscalPrinter;
import org.luque.print.fiscal.FiscalPacket;
import org.luque.print.fiscal.comm.FiscalComm;
import org.luque.print.fiscal.document.CreditNote; 
import org.luque.print.fiscal.document.Customer;
import org.luque.print.fiscal.document.DebitNote;
import org.luque.print.fiscal.document.DiscountLine;
import org.luque.print.fiscal.document.Document;
import org.luque.print.fiscal.document.DocumentLine;
import org.luque.print.fiscal.document.Invoice;
import org.luque.print.fiscal.document.NonFiscalDocument;
import org.luque.print.fiscal.document.Payment;
import org.luque.print.fiscal.document.Tax;
import org.luque.print.fiscal.exception.DocumentException;
...
import org.luque.print.fiscal.msg.FiscalMessage;
...
public abstract class HasarFiscalPrinter extends BasicFiscalPrinter implements HasarCommands, HasarConstants {
	...
	//Daniel Orlando Medina: metodo que permite especificar la longitud máxima de la descripcion, para los modelos que lo requieran.
	protected FiscalPacket cmdPrintLineItem(String description, BigDecimal quantity, BigDecimal price, BigDecimal ivaPercent, boolean substract, BigDecimal internalTaxes, boolean basePrice, Integer display, int descMaxLength) {
		...
		cmd.setNumber(i++,quantity,6,8,false);//cmd.setQuantity(i++, quantity, false);
